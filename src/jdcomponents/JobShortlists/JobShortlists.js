...
const AddShortlist = React.lazy(() => import('./AddShortlist'));
                                        ...
                                        <Row>
                                            <Col md={'auto'}>
                                                ...
                                                <InputGroup className="mb-3">
                                                    ...
                                                    <InputGroup.Append>
                                                        <AddShortlist // The invisible modal itself
                                                            key="modal1"
                                                            action={"add"}
...
JobShortlists.propTypes = {};

JobShortlists.defaultProps = {};

export default JobShortlists;
